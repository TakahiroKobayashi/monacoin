...
public:
    ...
    CKey GetKey();
    bool IsValid(bool bOldPrefix = false) const;
    bool SetString(const char* pszSecret, bool bOldPrefix = false);
    bool SetString(const std::string& strSecret, bool bOldPrefix = false);
